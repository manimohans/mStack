...
8. **Learn** - Use the installed product-retro skill after launch to capture reusable messaging lessons.
9. **Remember** - Use the installed learn skill to search or save durable voice, proof, positioning, customer-language, and launch lessons.
