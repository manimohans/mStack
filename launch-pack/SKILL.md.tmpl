...
name: launch-pack
description: >-
  Turn an approved product update or launch argument into a coordinated launch asset pack: blog post, changelog, release email, social posts, Slack/internal announcement, sales note, customer support note, and founder talking points. Use after a draft or angle is approved and the user wants channel-specific launch materials.
---
